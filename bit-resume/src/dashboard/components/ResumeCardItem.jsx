...
function ResumeCardItem({resume,refreshData}) {
  ...
  return (
       ...
       <div className=''>
        ...
        flex items-center justify-center h-[280px] rounded-lg border-t-4 hover:scale-105 transition-all hover:shadow-md shadow-primary'
        style={{
        ...
        items-center justify-center h-[180px] '>
                {/* <Notebook/> */}
                <img src="/cv.png" width={200} height={200} /> 
              </div>
        </div>
        </Link>
