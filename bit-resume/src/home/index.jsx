...
function Home() {
  return (
    ...
    <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-6 lg:px-12 lg:mt-10">
...
<div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
      ...
      >
       <AtomIcon className='h-8 w-8'/>
        ...
        <h2 className="mt-4 text-xl font-bold text-black">Write prompt for your Resume field</h2>

        <p className="mt-1 text-sm text-gray-600">
          Create a new resume from Start or Edit already made resume.
        </p>
      </a>
      ...
      <Edit className='h-8 w-8'/>
        ...
        <p className="mt-1 text-sm text-gray-600">
          Add your Personal details, Education, Experience and Skills.
        </p>
      </a>
      ...
      <Share2 className='h-8 w-8' />
        ...
        <p className="mt-1 text-sm text-gray-600">
          Download and Share your Resume URL.
        </p>
      </a>
    ...
    <div className="mt-12 text-center">
      <a
        href="mailto:omdasbaniya@gmail.com"
